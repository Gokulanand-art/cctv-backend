...
app.delete("/history/:filename", (req, res) => { const file = path.join(DATA_DIR, req.params.filename); if (!fs.existsSync(file)) return res.status(404).json({ error: "Not found" }); fs.unlinkSync(file); console.log("[✓] Deleted:", req.params.filename); res.json({ success: true }); });
